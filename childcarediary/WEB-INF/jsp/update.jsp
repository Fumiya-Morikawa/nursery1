            ...
            <div class="main-container">
                <div class="regist-container">
                    <form action="${ pageContext.request.contextPath }/UpdateServlet2" method="post">
                        <div class="text">
                            <div class="date">
                                日付：<input type="text" name="date" value="${ updateDiaryInfo1.date }"
                                      size=15 style="font-size:24px;" />
                            </div>
                            <div class="name">
                                記入者：<input type="text" name="name" value="${ updateDiaryInfo1.name }"
                                       size=15 style="font-size:24px;" />
                            </div>
                        </div>
                        <br>
                        <div class="aim">
                            <p>ねらい：<br>
                                <textarea name="aim" style="font-size:16px;" >${ updateDiaryInfo1.aim }</textarea>
                            </p>
                        </div>
                        <div class="contents">
                            <p>内容：<br>
                                <textarea name="contents" style="font-size:16px;" >${ updateDiaryInfo1.contents }</textarea>
                            </p>
                        </div>
